  ...
  return (
    <div className="w-full sticky top-0 flex h-[40px] bg-sidebar">
      <FilterSelect
        ...
        classNameValue="bg-red-200 !text-[#E6E6D9] "
        placeholder="Все операции"
        classNameContainer="bg-primary text-[#E6E6D9] !text-[#E6E6D9] "
        classNameItem="bg-[#5D5D53CC] hover:bg-[#5D5D53CC] !text-[#E6E6D9]  p-4 text-[20px]"
        defaultValue="all"
        name="sort"
      />
      <Button
