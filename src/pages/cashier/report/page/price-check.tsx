  ...
  return (
    <div className="w-full bg-card max-w-[312px] flex flex-col justify-between h-full p-[10px] pt-0 sticky top-10">
      <div className="w-full max-w-md bg-[#f8f6e9] text-[#5D5D53] p-5 mx-auto font-sans scrollCastom h-[470px]">
        {/* Header */}
        <h1 className="text-[18px] text-center text-[#5D5D53] mb-1">
          Sanat Hali
        </h1>
        <p className="text-center text-[#5D5D53] text-[10px] mb-6">
          Вс, Май 5, 2024 • 20:07:53
        </p>
        ...
        <div className="flex justify-between mb-2">
          ...
          <span className="text-[#5D5D53] text-[14px] font-medium">
            -189.00$
          </span>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex justify-between mb-2">
            ...
            <span className="text-[#5D5D53] text-[14px] text-right">
              г.Ташкент, ул.Фарабий 1 дом
            </span>
          </div>
        </div>
        ...
        <p className="text-[#5D5D53] text-[10px]">
          Arenda uchun fevral oyiga to'lov
        </p>
      </div>
