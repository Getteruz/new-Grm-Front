...
export const ProductCharacteristicColumns: ColumnDef<ProductCharacteristic>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [selectedCharacteristic, setSelectedCharacteristic] = useState<ProductCharacteristic | null>(null);
